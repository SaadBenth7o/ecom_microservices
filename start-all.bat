...
REM Demarrage Kafka
echo [1/11] Demarrage Kafka + Zookeeper...
...
REM Gateway
echo [3/11] Gateway Service - Port 8888...
...
REM Customer
echo [4/11] Customer Service - Port 8081...
...
REM Inventory
echo [5/11] Inventory Service - Port 8082...
...
REM Billing
echo [6/11] Billing Service - Port 8083...
...
REM Supplier
echo [7/11] Supplier Service - Port 8084...
...
REM MCP
echo [8/11] MCP Server - Port 8989...
...
REM Chatbot
echo [9/11] Chatbot Service - Port 8087...
...
REM Data Analytics
echo [10/11] Data Analytics - Port 8090...
